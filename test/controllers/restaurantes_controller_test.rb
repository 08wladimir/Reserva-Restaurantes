...
class RestaurantesControllerTest < ActionController::TestCase
  ...
  test "should create restaurante" do
    assert_difference('Restaurante.count') do
      post :create, restaurante: { direccion: @restaurante.direccion, horario: @restaurante.horario, mesas: @restaurante.mesas, nombre: @restaurante.nombre, telefono: @restaurante.telefono }
    end
  ...
  test "should update restaurante" do
    patch :update, id: @restaurante, restaurante: { direccion: @restaurante.direccion, horario: @restaurante.horario, mesas: @restaurante.mesas, nombre: @restaurante.nombre, telefono: @restaurante.telefono }
    assert_redirected_to restaurante_path(assigns(:restaurante))
  end
