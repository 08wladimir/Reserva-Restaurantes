...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { fecha: @reserva.fecha, hora: @reserva.hora, mesa: @reserva.mesa, restaurante_id: @reserva.restaurante_id, user_id: @reserva.user_id }
    end
  ...
  test "should update reserva" do
    patch :update, id: @reserva, reserva: { fecha: @reserva.fecha, hora: @reserva.hora, mesa: @reserva.mesa, restaurante_id: @reserva.restaurante_id, user_id: @reserva.user_id }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
